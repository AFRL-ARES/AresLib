...
namespace AresSerial
{
  ...
  public interface ISerialConnection
  {
    ...
    /// <exception cref="InvalidOperationException">Thrown when this method is called but <see cref="ListenerStatusUpdates"/> is not <see cref="ListenerStatus.Listening"/></exception>
    ...
    /// <param name="cancelToken">Cancellation token to cancel this particular listener</param>
    /// <param name="timeout">How long to wait for the response before timing out</param>
    /// <returns>An awaitable <see cref="Task"/> that returns the first <see cref="SerialCommandResponse"/> to arrive on the serial port</returns>
    ...
    /// is received, the operation times out due to <param name="timeout"/>, or the <param name="cancellationToken"/> is canceled
    ...
    /// <summary>
    /// Sends a request over the serial port and blocks the calling thread until a response
    /// is received or the <param name="cancellationToken"/> is canceled
    /// Note: Calling this from multiple threads does not guarantee order in which the requests are processed
    /// </summary>
    /// <param name="request">The command to be sent to the port</param>
    /// <param name="cancellationToken"></param>
